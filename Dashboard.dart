...
class _TaskListPageState extends State<TaskListPage> {
  ...
  void _showEditDialog(BuildContext context, int index) {
    final TextEditingController _titleController =
        TextEditingController(text: widget.taskManager.tasks[index].title);
    final TextEditingController _descriptionController = TextEditingController(
        text: widget.taskManager.tasks[index].description);

    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
          title: Text('Edit Tugas', style: TextStyle(color: Colors.teal)),
          content: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
...
class SettingsPage extends StatelessWidget {
  final List<String> notifications = [
    'Proyek Baru dibuat: Tugas Mobile - Belajar Flutter',
    'Proyek Baru dibuat: Tugas Mobile - Membuat UI',
    'Proyek Diperbarui: Tugas Mobile - Deskripsi diperbarui',
  ];
